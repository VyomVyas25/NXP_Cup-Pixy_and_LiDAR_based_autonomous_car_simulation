...
bool synapse_msgs__msg__pixy_vector__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // m0_x0
    ...
    ros_message->m0_x0 = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // m0_y0
    ...
    assert(PyLong_Check(field));
    ros_message->m0_y0 = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // m0_x1
    ...
    assert(PyLong_Check(field));
    ros_message->m0_x1 = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // m0_y1
    ...
    assert(PyLong_Check(field));
    ros_message->m0_y1 = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // m1_x0
    ...
    assert(PyLong_Check(field));
    ros_message->m1_x0 = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // m1_y0
    ...
    assert(PyLong_Check(field));
    ros_message->m1_y0 = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // m1_x1
    ...
    assert(PyLong_Check(field));
    ros_message->m1_x1 = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // m1_y1
    ...
    assert(PyLong_Check(field));
    ros_message->m1_y1 = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
PyObject * synapse_msgs__msg__pixy_vector__convert_to_py(void * raw_ros_message)
{
  ...
  {  // m0_x0
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->m0_x0);
    {
  ...
  {  // m0_y0
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->m0_y0);
    {
  ...
  {  // m0_x1
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->m0_x1);
    {
  ...
  {  // m0_y1
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->m0_y1);
    {
  ...
  {  // m1_x0
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->m1_x0);
    {
  ...
  {  // m1_y0
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->m1_y0);
    {
  ...
  {  // m1_x1
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->m1_x1);
    {
  ...
  {  // m1_y1
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->m1_y1);
    {
